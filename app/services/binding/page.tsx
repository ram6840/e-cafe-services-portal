              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                <div>
                  ...
                  <p className="text-sm text-gray-300 mt-1">
                    Professional binding services for documents and books
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="bg-[#1E293B] border border-[#334155] rounded-lg px-4 py-4 mb-6">
                <p className="text-gray-300 text-sm">
                  We provide professional binding services for documents, reports, thesis, books, 
                  and other materials. Our binding options include spiral binding, perfect binding, 
                  and hardcover binding to suit various requirements.
                </p>
              </div>
