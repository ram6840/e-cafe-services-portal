...
export default function PVCPrintingPage() {
  return (
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                <div>
                  <h1 className="text-lg md:text-xl font-semibold text-white">
                    PVC Printing Services
                  </h1>
                  <p className="text-sm text-gray-300 mt-1">
                    Professional PVC card printing services
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="bg-[#1E293B] border border-[#334155] rounded-lg px-4 py-4 mb-6">
                <p className="text-gray-300 text-sm">
                  We provide professional PVC card printing services for ID cards, visiting cards, 
                  membership cards, and custom PVC cards. Our high-quality printing ensures durable 
